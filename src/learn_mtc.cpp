...
// 상수 파라미터 (테이블 관련 제거)
// ──────────────────────────────────────────────
static constexpr char ARM_GROUP[]   = "panda_arm";
static constexpr char HAND_GROUP[]  = "hand";
static constexpr char HAND_FRAME[]  = "panda_hand";
static constexpr char WORLD_FRAME[] = "world";
static constexpr char OBJECT_NAME[] = "object";

// 물체 위치: 로봇이 잡기 편한 위치
static constexpr double OBJ_X = 0.55; 
static constexpr double OBJ_Y = 0.0;
static constexpr double OBJ_Z = 0.2; // 0.05에서 0.2로 변경 (공중에 확실히 띄움)

// 내려놓을 위치
static constexpr double PLACE_X = 0.55;
static constexpr double PLACE_Y = 0.3;
static constexpr double PLACE_Z = 0.05;
